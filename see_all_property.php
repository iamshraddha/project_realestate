...
<?php
	...
	properties.property_type as propertytype,properties.price as price,properties.area as area,properties.amenities as amenities, states.name as statename,users.username as username from properties,users,states where users.id=properties.user_id AND states.id=properties.state_id";
