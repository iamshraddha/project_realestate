...
<?php
	...
	$sql="select enquiries.id as id,enquiries.name as name,enquiries.city as city,enquiries.address as address,enquiries.contact_number as contactnumber,enquiries.email as email,enquiries.message as message,states.name as statename,properties.title as propertytitle from users, enquiries,states,properties where states.id=enquiries.state_id AND properties.id=enquiries.property_id AND states.id=users.state_id";
